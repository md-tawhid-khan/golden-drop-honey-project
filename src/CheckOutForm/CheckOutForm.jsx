...
{/*  --------------- main section in product details ---------- */}
     ...
     <div className="flex items-center justify-between pt-7 pb-3">
        ...
        <div>
            <p>{product.price} <span className="ml-3 text-3xl">৳ </span></p>
        </div>
     </div>
    {/* ----------- subtotal section ----------- */}
     <div className="flex items-center justify-between p-5 border border-x-0">
        <h1>Subtotal</h1>
        <p className="text-[#FFB700]">{product.price} <span className="ml-3 text-3xl">৳ </span> </p>
     </div>
  ...
  <label className="label cursor-pointer gap-4">
    ...
    <input type="radio" name="theme-radios"  value="default" />
  </label>
</div>
<div className="form-control">
  <label className="label cursor-pointer gap-4">
    <span className="label-text">OutSide Dhaka</span>
    <input type="radio" name="theme-radios" value="retro" />
  </label>
</div>
     </div>
     </div>
...
<div className="m-2 px-3 flex flex-col gap-4 ">
    ...
    <p className="bg-white p-3">Pay with cash upon delivery.</p>
</div>
